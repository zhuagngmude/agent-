...
- [重新立项说明.md](./重新立项说明.md)：当前重新立项结论、产品边界和技术栈定案。
- [目录架构确认.md](./目录架构确认.md)：新项目目录与边界口径。
- [共享UI方案确认.md](./共享UI方案确认.md)：唯一 UI 源和入口分层口径。
- [AI开发维护手册.md](./AI开发维护手册.md)：后续 AI 进入项目时的操作边界和维护规则。
- [新窗口交接说明.md](./新窗口交接说明.md)：当前工作状态和交接快照。
- [下一步开发路线.md](./下一步开发路线.md)：当前阶段、下一步和禁止事项。
- [旧原型归档方案.md](./旧原型归档方案.md)：旧 Web 原型、旧 Node Mock API 和设计原型的冻结参考口径。
