...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::agent_config::list_executor_configs,
            commands::agent_config::upsert_executor_config,
            commands::agent_config::delete_executor_config,
            commands::agent_config::list_executor_models,
            commands::agent_config::upsert_executor_model,
            commands::agent_config::delete_executor_model,
            commands::agent_config::list_agent_templates,
            commands::agent_config::upsert_agent_template,
            commands::agent_config::delete_agent_template,
            commands::agent_config::list_project_agents,
            commands::agent_config::upsert_project_agent,
            commands::agent_config::remove_project_agent,
            commands::agent_config::list_executor_skills,
            commands::agent_config::upsert_executor_skill,
            commands::agent_config::delete_executor_skill,
            commands::agent_config::list_agent_boundary_checks,
            commands::agent_config::recommend_project_agents,
            commands::agent_config::check_agent_boundary,
            ...
            commands::tasks::open_task_output_folder,
            commands::tasks::get_task_agent_info,
            commands::tasks::assign_project_agents_to_task,
            ...
            commands::auto_swarm::continue_swarm_tasks,
