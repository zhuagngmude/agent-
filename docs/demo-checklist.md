...
- Provider adapter verification currently covers only the disabled adapter stub; demo verification must not import provider SDKs, make provider requests, require real keys, store responses, or report raw provider errors.
