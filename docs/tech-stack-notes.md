...
本文记录 `agent蜂群` 的技术栈、老师反馈后的调整方向，以及重新立项后已确认的正式技术栈。

> 2026-06-17 更新：文中“只读链路”“不写完整真实业务功能”等早期描述已经过期。当前桌面端全自动 Runner 主链路已经开放，当前产品状态以 `dev-docs/当前项目导航.md` 为准。
...
4. 旧原型价值已进入归档目录，当前不再依赖单独的旧原型说明稿。
